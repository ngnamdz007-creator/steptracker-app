...
public final class FragmentAchievementBinding implements ViewBinding {
  ...
  private FragmentAchievementBinding(@NonNull LinearLayout rootView, @NonNull ChipGroup chipGroup,
  ...
  public static FragmentAchievementBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAchievementBinding((LinearLayout) rootView, chipGroup, progressBar,
